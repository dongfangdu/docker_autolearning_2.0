...
from app.libs.error_code import ResultSuccess, DeleteSuccess, CreateSuccess, EditSuccess, PageResultSuccess
from app.libs.qpaginate import pager
from app.libs.redprint import Redprint
from app.libs.token_auth import auth
from app.models.base import db_v1
from app.models.v1.sysmng import Permission
from app.validators.base import PageForm
from app.validators.forms_v1 import PermissionForm, PermissionEditForm, IDForm
...
def permission_edit():
    ...
    return EditSuccess(msg=u'权限修改成功')
...
def permission_list():
    ...
    permssion_objs = Permission.query.filter_by().order_by(Permission.create_time.desc())
    ...
    return PageResultSuccess(msg=u'权限列表', data=vms, page=rvs.page_view())
...
def permission_choices_name():
    ...
    return ResultSuccess(msg=u'权限名称字典', data=vms)
