...
class UtteranceAccess(Base):
    __incomplete_tablename__ = 'utterance_access'
    ...
    def keys(self):
        return ['ng_version', 'id', 'request_id', 'time', 'app', 'group', 'ip', 'app_key', 'session_id', 'device_uuid',
                ...
                'customization_id', 'class_vocabulary_id', 'result', 'group_name', ]


class UtteranceAudio(Base):
    __incomplete_tablename__ = 'utterance_audio'
    ...
    is_assigned = Column(SmallInteger, nullable=False, server_default=FetchedValue())
    uttr_status = Column(SmallInteger)

    def keys(self):
        return ['id', 'request_id', 'path', 'url', 'truncation_ratio', 'volume', 'snr', 'pre_snr', 'post_snr',
                'is_assigned', 'uttr_status', ]


class UtteranceAccessAll(Base):
    __incomplete_tablename__ = 'utterance_access_all'
...
class UtteranceAudioAll(Base):
    __incomplete_tablename__ = 'utterance_audio_all'
