...
#from ops import *
from app.libs.enhance.bnorm import VBN
from app.libs.enhance.ops import *
import timeit
import os
...
class SEGAN(Model):
    ...
    def __init__(self, sess, args, devices, infer=False, name='SEGAN'):
        ...
        self.g_dilated_blocks = [1, 2, 4, 8, 16, 32, 64, 128, 256]
            # num fmaps for AutoEncoder SEGAN (v1)

        #self.g_enc_depths = [16, 32, 32, 64, 64, 128, 128, 256, 256, 512, 1024]
        self.g_enc_depths = [8, 16, 16, 32, 32, 64, 64, 128, 128, 256, 512]

        # Define D fmaps
            #self.d_num_fmaps = [16, 32, 32, 64, 64, 128, 128, 256, 256, 512, 1024]
        self.d_num_fmaps = [8, 16, 16, 32, 32, 64, 64, 128, 128, 256, 512]
