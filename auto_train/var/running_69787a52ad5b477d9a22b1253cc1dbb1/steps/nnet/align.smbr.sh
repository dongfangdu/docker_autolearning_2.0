...
lats_decode_opts="--acoustic-scale=0.1 --beam=13 --lattice-beam=7"
...
if [ $stage -le 1 ]; then
  ...
  $cmd JOB=1:$nj $dir/log/lat.JOB.log \
    latgen-faster-mapped $lats_decode_opts --max-mem=20000000 --max-active=5000 --word-symbol-table=$lang/words.txt $dir/final.mdl \
